...
const syncButton = tv({
  base: 'flex items-center text-black dark:text-white text-xs rounded-md px-1.5 py-1 border border-[#D7DCE5] gap-1.5 before:w-2 before:h-2 before:rounded-full',
  variants: {
    syncing: {
