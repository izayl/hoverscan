...
export const overviewSlot = tv({
  slots: {
    ...
    networkName: 'font-semibold text-sm text-black dark:text-gray-300 dark:font-normal',
    overviewInfo: 'font-normal text-xs text-gray-600 dark:text-gray-400',
    asset: "after:content-['•'] after:mx-1",
    txn: '',
    indicatorRight: 'ml-auto dark:text-gray-300',
  },
})
